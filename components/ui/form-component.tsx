...
const models = [
    // xAI Models
    { value: "xai:grok-2-1212", label: "Grok 2.0", icon: Zap, description: "Most intelligent text model", provider: "xai", color: "glossyblack", vision: false },
    { value: "xai:grok-2-vision-1212", icon: ScanEye, label: "Grok 2.0 Vision", description: "Most intelligent vision model", provider: "xai", color: "offgray", vision: true },
];
