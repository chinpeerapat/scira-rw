...
import { clientEnv, isMapboxEnabled } from "@/env/client";
...
const MapComponent: React.FC<MapProps> = ({ center, places = [], zoom = 13, onMarkerClick }) => {
  ...
  useEffect(() => {
    ...
    if (!isMapboxEnabled()) {
      console.warn('Mapbox is not configured. Please provide a Mapbox access token.');
      return;
    }
